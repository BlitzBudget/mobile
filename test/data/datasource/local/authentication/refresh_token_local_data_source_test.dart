...
void main() {
  late RefreshTokenLocalDataSourceImpl dataSource;
  SecureKeyValueStoreImpl? mockSecureKeyValueStoreImpl;
  const refreshTokenCacheName = 'refresh_token';
    ...
    test(
      ...
      () async {
        ...
        when(() => mockSecureKeyValueStoreImpl!
                .getString(key: refreshTokenCacheName))
    ...
    test(
      ...
      () async {
        ...
        when(() => mockSecureKeyValueStoreImpl!.getString(
            key: refreshTokenCacheName)).thenThrow(NoValueInCacheException());
        // assert
    ...
    test(
      ...
      () async {
        ...
        when(() => mockSecureKeyValueStoreImpl!.setString(
            key: refreshTokenCacheName,
            value: refreshTokenValue)).thenAnswer((_) => Future.value());
        // act
        await dataSource.writeRefreshToken(refreshTokenValue);
        // assert
        verify(() => mockSecureKeyValueStoreImpl!
            .setString(key: refreshTokenCacheName, value: refreshTokenValue));
      },
    );
  });
}
