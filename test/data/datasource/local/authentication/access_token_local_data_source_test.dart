...
void main() {
  ...
  const accessTokenCacheName = 'access_token';
    ...
    test(
      ...
      () async {
        ...
        when(() => mockSecureKeyValueStoreImpl!
                .getString(key: accessTokenCacheName))
    ...
    test(
      ...
      () async {
        ...
        when(() => mockSecureKeyValueStoreImpl!.getString(
            key: accessTokenCacheName)).thenThrow(NoValueInCacheException());
        // assert
    ...
    test(
      ...
      () async {
        ...
        verify(() => mockSecureKeyValueStoreImpl!
            .setString(key: accessTokenCacheName, value: accessTokenValue));
      },
    );
  });
}
