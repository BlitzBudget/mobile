...
abstract class UpdateUserAttributesRemoteDataSource {
  Future<void> updateUserAttributes(UserModel userModel);
}

class UpdateUserAttributesRemoteDataSourceImpl
    implements UpdateUserAttributesRemoteDataSource {
  ...
  UpdateUserAttributesRemoteDataSourceImpl({@required this.httpClient});
  ...
  @override
  Future<UserResponseModel> updateUserAttributes(UserModel userModel) async {
    try {
      return httpClient
